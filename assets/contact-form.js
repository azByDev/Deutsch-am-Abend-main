...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
      ...
      var inquiryType = (form.querySelector('[name="inquiry_type"]') || {}).value || 'General';
      ...
      var fullSubject = 'Contact Inquiry [' + inquiryType + ']: ' + subject + ' — ' + name;
      var body = [
        'NEW CONTACT INQUIRY',
        '====================',
        'Name: ' + name,
      ...
      fetch('https://api.web3forms.com/submit', {
        ...
        .then(function (data) {
          if (data.success) {
            if (statusEl) {
              ...
              statusEl.textContent = 'Thank you, ' + name + '! Your message has been sent. We will reply to ' + email + ' within 24–48 hours.';
              statusEl.style.display = 'block';
            }
            form.reset();
          } else {
        ...
        .catch(function () {
          if (statusEl) {
            ...
            statusEl.textContent = 'Something went wrong sending your message. Please try again or email us directly at ' + FALLBACK_EMAIL + '.';
            statusEl.style.display = 'block';
          }
        })
        .finally(function () {
